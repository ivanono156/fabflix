...
# copy the war file what we have generated earlier intao the tomcat webapps folder inside the container
COPY --from=builder /app/target/cs122b-fall24-project.war /usr/local/tomcat/webapps/cs122b-fall24-project.war
